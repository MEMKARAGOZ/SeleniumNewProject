...
public class C02_WebElementLocators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ilkUrun.isDisplayed() = " + ilkUrun.isDisplayed());
        // ilk ürünün, erisilebilir olup olmadıgını true, false seklinde yazdırın
        System.out.println("ilkUrun.isEnabled() = " + ilkUrun.isEnabled());
        // ilk ürünün, secilebilir olup olmadıgını true, false seklinde yazdırın
        System.out.println("ilkUrun.isSelected() = " + ilkUrun.isSelected());
        // ilk urune tıklayın
        ilkUrun.click();
        // sayfayı kapatın
        driver.close();
